...
function actualizar_info(ev) {
    ...
    peticion.open(
        "POST",
        "http://mante.hosting.acm.org/SIIAA_backend/negocios/php/shared/editar_info/editar_info.php"
    );
...
btnConfirmar.addEventListener("click", actualizar_info);